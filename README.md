...
Its bbappends wildcard the patch release of the recipe version they target, so they should apply to `scarthgap` recipes regardless of the exact used Yocto version.
